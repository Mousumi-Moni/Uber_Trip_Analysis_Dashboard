...
Power BI dashboard analyzing Uber trip data to track bookings, revenue, trip distance, time-based demand trends, and location insights with drill-through analysis.

Project Overview :
  
  The Uber Trip Analysis Dashboard is an end-to-end business intelligence project built using Power BI to analyze ride-hailing operations.
